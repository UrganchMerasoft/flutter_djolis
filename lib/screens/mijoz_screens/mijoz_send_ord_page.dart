...
//                       ),
//                       child: selectedImage1 != null ? const SizedBox.shrink() : Column(
//                         mainAxisAlignment: MainAxisAlignment.center,
...
//                         ),
//                         child: selectedImage2 != null ? const SizedBox.shrink() : Column(
//                           mainAxisAlignment: MainAxisAlignment.center,
//                           crossAxisAlignment: CrossAxisAlignment.center,
//                           children: [
//                             const Icon(Icons.add_a_photo_outlined),
...
//     Uri uri = Uri.parse("${settings.serverUrl}/api-djolis/send-mijoz-order");
...
//   }
//
//   void sendToTelegram(File imageFile) async{
//     const String botToken = '7748825814:AAG1HdUZbxcC8SLhgCpVB9xxJHtyQO1q2KQ';
//     const String chatId = '58955123';
//
//     final telegram = Telegram(botToken);
//
//     final result = await telegram.sendPhoto(chatId, imageFile, caption: "Yangi skrinshot!");
//     if (result.photo != null) {
//       print("Rasm Telegramga muvaffaqiyatli yuborildi!");
//     } else {
//       print("Xatolik: Telegramga yuborilmadi: ${result.text}");
//     }
//   }
//
// }
                          ...
                          child: ElevatedButton(
                              ...
                              onPressed: isSending ? null : () {
                                if (selectedImage1 == null) {
                                  showRedSnackBar("Iltimos, chekning rasmini (skrinshot) biriktiring!");
                                } else {
                                  sendOrder(settings);
                                }
                              },
