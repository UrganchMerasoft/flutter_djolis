            ...
            children: [
              ...
              Visibility(
                child: ExpansionTile(
                  ...
                  collapsedShape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20), side: BorderSide(color: Colors.grey)),
                  ...
                  title: Row(
                    ...
                    children: [
                      Text(AppLocalizations.of(context).translate("pay_on_delivery"),
                          style: TextStyle(fontWeight: FontWeight.w500, fontSize: 16, color: Theme.of(context).brightness == Brightness.dark ? Colors.grey.shade200 : Colors.grey.shade600)),
                    ],
                  ),
                        ...
                        Expanded(
                          ...
                          child: ElevatedButton(
                              ...
                              onPressed:() {
                                ...
                                if(selectPay == 1 && deliveryDateController.text.isNotEmpty) {
                                  sendOrder(settings);
                                  return;
                                }
                                if(selectPay == 0 && deliveryDateController.text.isEmpty || _paymentInProgress || !_paymentCompleted){
                                  showRedSnackBar(AppLocalizations.of(context).translate("payment_required_before_order"));
                                  return;
                                }
                                if (!_paymentCompleted) {
